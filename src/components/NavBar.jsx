...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full p-[20px] md:h-20 text-white px-4  bg-black fixed">
      <div>
        <h1 className="text-5xl font-signature ml-2">Venkat</h1>
      </div>
